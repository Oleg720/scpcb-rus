;Благодаря неведомой магии, в игре заработало Сглаживание текста
...
Type AAFont
	...
	Field x%[255] ;not going to bother with unicode ;128
	Field y%[255]
	Field w%[255]
	Field h%[255]
...
Function AALoadFont%(file$="Arial Cyr", height=13, bold=0, italic=0, underline=0, AATextScaleFactor%=2) ;Tahoma
