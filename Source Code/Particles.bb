...
Function UpdateEmitters()
	...
	If InSmoke Then
		...
		If EyeIrritation > (70 * 24) Then 
			DeathMSG = "Субъект D-9341 найден мёртвым в [ДАННЫЕ УДАЛЕНЫ]. Причина смерти: удушение из-за отравления газом." ;Subject D-9341 found dead in [DATA REDACTED]. Cause of death: Suffocation due to decontamination gas.
			Kill()
		EndIf
